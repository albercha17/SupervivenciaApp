...
public class UNOVSUNO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while(listaNombres.size()>0){
            if(contador%2==0) {
                equipo1.add(new Superviviente(listaNombres.get(0)));
            }
            else{
                equipo2.add(new Superviviente(listaNombres.get(0)));
            }
        ...
        for(int i=0; i<numP;i++){
            equipo1.add(equipo1.get(i));
            equipo2.add(equipo2.get(i));
        }
